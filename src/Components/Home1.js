                ...
                <div className="carousel-inner">
                    <div className="carousel-item active">
                        ...
                        <div className="carousel-caption d-none d-md-block">
                            <h1>Onlie truck Booking make easy</h1>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block">
                            <h1>Book Truck and Check Fare Online Instantly</h1>
                    ...
                    <div className="carousel-item">
                        ...
                        <div className="carousel-caption d-none d-md-block">
                            <h1>Check Truck Type or Fare Online</h1>
...
<div className='home-con'>
    <h1>TruckGuru Online Truck Transport Services in India for Your Business</h1>
